...
import { getBirthdayCakesProducts } from "@/data/products/birthday-cakes";

const BirthdayCakesPage = () => {
  const products = getBirthdayCakesProducts();
  return (
    <>
      <section className="pt-40 pb-20 px-4 bg-white">
        <div className="container mx-auto max-w-7xl">
          ...
          <p className="text-center text-lg text-gray-600 mb-8">
            We offer a wide range of birthday cakes balloons to help you create
