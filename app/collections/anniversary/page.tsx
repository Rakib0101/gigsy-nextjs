...
import { getAnniversaryProducts } from "@/data/products/anniversary";

const AnniversaryPage = () => {
  const products = getAnniversaryProducts();
  return (
    <>
      <section className="pt-52 pb-20 px-4 bg-white">
        <div className="container mx-auto max-w-7xl">
          ...
          <p className="text-center text-lg text-gray-600 mb-8">
            We offer a wide range of anniversary balloons to help you create the perfect
            balloon display.
          </p>
