...
import { getWelcomeHomeProducts } from "@/data/products/welcome-home";

const WelcomeHomePage = () => {
  const products = getWelcomeHomeProducts();
  return (
    <>
      <section className="pt-40 pb-20 px-4 bg-white">
        <div className="container mx-auto max-w-7xl">
          ...
          <p className="text-center text-lg text-gray-600 mb-8">
            We offer a wide range of welcome home balloons to help you create
