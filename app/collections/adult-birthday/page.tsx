...
import { getAdultBirthdayProducts } from "@/data/products/adult-birthday";

const AdultBirthdayPage = () => {
  const products = getAdultBirthdayProducts();
  return (
    <>
      <section className="pt-40 pb-20 px-4 bg-white">
        <div className="container mx-auto max-w-7xl">
          ...
          <p className="text-center text-lg text-gray-600 mb-8">
            We offer a wide range of adult birthday balloons to help you create
