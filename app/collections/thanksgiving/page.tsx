...
import { getThanksgivingProducts } from "@/data/products/thanksgiving";

const ThanksgivingPage = () => {
  const products = getThanksgivingProducts();
  return (
    <>
      <section className="py-20 px-4 bg-white">
        <div className="container mx-auto max-w-7xl">
          ...
          <p className="text-center text-lg text-gray-600 mb-8">
            We offer a wide range of thanksgiving balloons to help you create
