...
const Feature = () => {
      ...
      <div className={`rounded-lg bg-[#35353a] text-white px-6 py-5 transition`}>
        ...
        >
          ...
          <span className="border border-white rounded-full w-7 h-7 flex items-center justify-center select-none">
            <span className={`text-2xl text-white leading-none transition-transform duration-300 ${isOpen ? '' : ''}`}>
              {isOpen ? "−" : "+"}
            </span>
          </span>
        </button>
        ...
        >
          <div ref={contentRef} className="mt-3 text-base md:text-lg text-left leading-snug pb-4">
            {a}
          </div>
        </div>
      </div>
  ...
  return (
    <>
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="flex justify-center items-center">
            <div className="w-full text-center flex flex-col gap-4 items-center justify-center max-w-[360px] bg-white/40 backdrop-blur-sm border border-white-200 rounded-xl px-6 py-12">
              ...
              <p className="text-gray-500 uppercase text-xl">
      ...
      <section className="py-12">
        <div className="container mx-auto">
          <div className="max-w-[825px] mx-auto flex flex-col lg:flex-row gap-8 rounded-2xl bg-[#f9f3f1] px-12 py-16">
    ...
    <div className="container mx-auto pb-12">
      <div className="max-w-xl mx-auto flex flex-col md:flex-row justify-between rounded-xl bg-[#f9f3f1] px-8 py-8">
        {/* Left section: Pickup info */}
        <div className="flex-1">
          <h2 className="text-2xl md:text-3xl font-bold text-[#46444e] mb-4 leading-none">
            PICK UP<br />AVAILABLE
          </h2>
